...
export const translations = {
  fr: {
    ...
    home: {
      ...
      choosePlan: {
        ...
        weightLoss: {
          ...
          features: {
            calorieControlled: 'Repas faibles en glucides',
            lowGlycemic: 'Indice glycémique très faible',
            highFiber: 'Riches en fibres et protéines',
    ...
    waitlist: {
      ...
      socialProof: {
        waitlistCount: '46 personnes sur la liste d\'attente',
      ...
      faq: {
        ...
        q1: {
          ...
          answer: 'Fitnest est déjà opérationnel. Nous ajoutons progressivement des personnes chaque semaine depuis notre liste d\'attente afin de maintenir la qualité de nos services et de répondre à la demande croissante de manière contrôlée.',
        },
        q2: {
          question: 'Combien coûtent les plans de repas ?',
          answer: 'À partir de 145 dhs par jour, vous pouvez commencer votre parcours avec Fitnest. Les membres de la liste d\'attente bénéficient de 20% de réduction sur leur premier mois lors du lancement.',
        },
        q3: {
      ...
      cta: {
        ...
        description: 'Rejoignez 46 personnes qui sont déjà sur la liste d\'attente pour l\'avenir de l\'alimentation saine au Maroc.',
        joinNow: 'Rejoindre la liste d\'attente maintenant',
        learnMore: 'En savoir plus',
        privacy: 'Pas de spam, jamais. Désabonnez-vous à tout moment. Accès anticipé garanti pour les membres de la liste d\'attente.',
      },
      waitlistReason: {
        title: 'Pourquoi une liste d\'attente ?',
        description: 'Pour garantir la qualité de nos processus et rester cohérents, nous limitons actuellement les nouvelles inscriptions et ajoutons de nouveaux membres chaque semaine en raison de la surcharge que nous recevons. C\'est pourquoi nous avons mis en place une liste d\'attente.',
      },
    },
  },
  en: {
    ...
    home: {
      ...
      choosePlan: {
        ...
        weightLoss: {
          ...
          features: {
            calorieControlled: 'Low carb meals',
            lowGlycemic: 'Very low glycemic index',
            highFiber: 'Rich in fiber and protein',
