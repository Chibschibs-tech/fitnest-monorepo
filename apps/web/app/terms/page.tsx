      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-gray-500 mb-8 sm:mb-12 text-center">
            {t.legal.terms.lastUpdated}: {new Date().toLocaleDateString(locale === 'fr' ? 'fr-FR' : 'en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
          </p>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 sm:p-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-fitnest-green mb-4 sm:mb-6">
                  {t.legal.terms.definitions.title}
                </h2>
                <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700">
                  <p><strong>"{t.legal.terms.definitions.service}"</strong></p>
                  <p><strong>"{t.legal.terms.definitions.user}"</strong></p>
                  <p><strong>"{t.legal.terms.definitions.subscription}"</strong></p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700 leading-relaxed">
                  <p>{t.legal.terms.account.content1}</p>
                  <p>{t.legal.terms.account.content2}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
                  {t.legal.terms.subscriptions.intro}
                </p>
                <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700 ml-4">
                  <li>{t.legal.terms.subscriptions.item1}</li>
                  <li>{t.legal.terms.subscriptions.item2}</li>
                  <li>{t.legal.terms.subscriptions.item3}</li>
                  <li>{t.legal.terms.subscriptions.item4}</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 sm:p-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-fitnest-green mb-4 sm:mb-6">
                  {t.legal.terms.delivery.title}
                </h2>
                <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
                  {t.legal.terms.delivery.intro}
                </p>
                <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700 ml-4">
                  <li>{t.legal.terms.delivery.item1}</li>
                  <li>{t.legal.terms.delivery.item2}</li>
                  <li>{t.legal.terms.delivery.item3}</li>
                  <li>{t.legal.terms.delivery.item4}</li>
                  <li>{t.legal.terms.delivery.item5}</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md bg-fitnest-green/5">
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700">
                  <p><strong>{t.legal.terms.contact.email}</strong></p>
                  <p><strong>{t.legal.terms.contact.phone}</strong></p>
