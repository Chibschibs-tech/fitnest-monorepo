    ...
    <div className="container mx-auto py-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Prix de base, regles par repas et catalogue d ingredients. Toute modification est immediatement visible sur le site.</p>
        </div>

        {msg && <div className="mb-4 rounded-md bg-green-50 border border-green-200 px-4 py-2 text-sm text-green-800">{msg}</div>}

        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-1">Regles par type de repas</h2>
          <p className="text-sm text-gray-600 mb-3">Le prix de base couvre les quantites incluses ci-dessous. Au-dela, le client paie un supplement.</p>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 text-left">
                <tr>
                  ...
                  <th className="p-3">Proteines incl.</th>
                  <th className="p-3">Feculents incl.</th>
                  <th className="p-3">Legumes incl.</th>
                  <th className="p-3">Sauces incl.</th>
                  <th className="p-3">Max supplements</th>
                  <th className="p-3">Proteine obligatoire</th>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-1">Catalogue d ingredients</h2>
          <p className="text-sm text-gray-600 mb-3">Premium = supplement paye meme dans la portion incluse. Portion sup. = prix d une portion au-dela de l inclus.</p>

          <div className="rounded-xl border bg-white p-4 mb-6">
            <p className="text-sm font-medium mb-3">Ajouter un ingredient</p>
            <div className="flex flex-wrap gap-2 items-end">
              ...
              <input type="number" title="Proteines (g)" value={newItem.protein_g} onChange={(e) => setNewItem({ ...newItem, protein_g: Number(e.target.value) })} className={cell} />
